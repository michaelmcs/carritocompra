...
<body>
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="background-color: #4FA9FB !important;">
  <span class="navbar-brand">
      <img src="img/logo-mywebsite-urian-viera.svg" alt="" width="120">
        Baby Style
  </span>
...
<br><br>
<h4 class="text-center">Bienvenido a Baby Style</h4>
<hr>
<br><br>
 ...
 <div class="col-md-3">
    <div class="thumbnail" style="text-align: center;border: 1px solid #ece; margin: 10px 0px;">
      ...
      <div class="caption">
        ...
        <p>
        S/.
            <?php echo number_format($Product['precio'],2, ".", ","); ?> </p>
